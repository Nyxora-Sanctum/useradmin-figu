  ...
  <div class="w-full sm:w-1/2 bg-white flex flex-col justify-center items-center px-8 py-10">
    <div class="w-full max-w-md">
      ...
      <div class="mb-4 relative">
        <label for="gender" class="block text-gray-5wha00 mb-1">Gender</label>
        <select name="gender" id="gender"
          class="w-full border border-gray-300 rounded-md px-4 py-2 pr-10 appearance-none bg-white focus:outline-none focus:ring-2 focus:ring-blue-600"
          required>
        ...
        <svg class="absolute right-3 top-1/2 transform -translate-y-1/8 w-4 h-4 text-gray-500 pointer-events-none"
