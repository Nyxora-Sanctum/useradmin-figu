...
<div class="w-1/2 bg-white flex flex-col justify-center items-center px-16 py-10">
    <div class="w-full max-w-md">
        ...
        <div class="relative mb-6 text-center">
            ...
            <span class="absolute top-[-12px] bg-white px-4 text-sm text-gray-500 left-1/2 transform -translate-x-1/2">
                Please log in first
            </span>
        </div>
        ...
        <form id="loginForm" method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="username" name="username" class="w-full border border-gray-300 rounded-md px-4 py-2" required placeholder="Enter your username" />
            </div>
            <div class="mb-4">
                <label for="password" class="block text-gray-700 mb-1">Password</label>
                <input type="password" id="password" name="password" class="w-full border border-gray-300 rounded-md px-4 py-2" required placeholder="Enter your password" />
            </div>
            <button type="submit" class="w-full bg-blue-800 text-white px-4 py-2 rounded-md hover:bg-blue-900 transition mt-6">
                Log In
            </button>

            <div class="mt-6 text-center">
                <p>Don’t have an account? <a href="{{ route('register') }}" class="text-blue-600 hover:underline">Register Today.</a></p>
