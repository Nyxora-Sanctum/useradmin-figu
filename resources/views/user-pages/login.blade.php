...
<body>
    ...
    <div class="about-welcome-section-area login"
        style="background-image: url(assets/images/background/emailbg.png); background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="about-welcome-header text-center heading3">
                        <a href="index.html"><img src="assets/images/logo/logo4.png" alt=""
                                class="logo4"></a>
                    ...
                    <div class="login-boxarea heading6">
                        <h2>Welcome Back</h2>
                        <div class="space16"></div>
                        <p>Please fill your username and password to sign in.</p>
                        <div class="space50"></div>
                        ...
                        <div class="space40"></div>
                        <div class="btn-area">
                            <a href="verify.html" class="header-btn2"><img
                                    src="assets/images/elements/google-img1.png" alt="">Sign Up With
                                Google</a>
                            <div class="space24"></div>
                            <a href="verify.html" class="header-btn2"><img
                                    src="assets/images/elements/google-img2.png" alt="">Sign Up With
                                Facebook</a>
                        </div>
                    </div>
                </div>
